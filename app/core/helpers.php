...
function book_i18n(string $lang): array {
    $ro = [
        ...
        'choose_hint'=>'Selecteaza un serviciu din stanga ca sa vezi orele disponibile.',
        'search'=>'Cauta serviciu...', 'no_match'=>'Niciun serviciu gasit.',
