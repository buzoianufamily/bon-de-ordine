...
$bid = (int)$branch['id'];
$turl = fn($t)=>url('backoffice/branches/'.$bid.'?tab='.$t);
...
<div class="crumb"><a href="<?= e(url('backoffice/branches')) ?>">Filiale</a> › <?= e($branch['name']) ?></div>
<div class="ehead">
  <div class="eic">🏢</div>
  <div style="flex:1">
  ...
  <div class="eact"><a class="btn" href="<?= e(url('backoffice/branches/'.$bid.'/edit')) ?>">✎ Editeaza filiala</a></div>
</div>
...
<?php if($tab==='services'): ?>
  <div class="topbar" style="margin-bottom:1rem"><h3 style="margin:0">Servicii</h3><a class="btn btn-primary" href="<?= e(url('backoffice/services/new?branch='.$bid)) ?>">+ Serviciu</a></div>
  <div class="cardgrid">
  <?php foreach($services as $r): ?>
    <div class="mcard">
      ...
      <div class="card-foot"><span class="st <?= $r['status']==='active'?'on':'' ?>"><span class="d"></span><?= $r['status']==='active'?'Activ':'Inactiv' ?></span>
        <a class="lnk" href="<?= e(url('backoffice/services/'.$r['id'])) ?>">Editeaza</a></div>
    </div>
  <?php endforeach; ?>
...
<?php elseif($tab==='counters'): ?>
  <div class="topbar" style="margin-bottom:1rem"><h3 style="margin:0">Ghisee</h3><a class="btn btn-primary" href="<?= e(url('backoffice/counters/new?branch='.$bid)) ?>">+ Ghiseu</a></div>
  <div class="cardgrid">
  <?php foreach($counters as $r): ?>
    <div class="mcard">
      ...
      <div class="card-foot"><span class="st <?= $r['status']==='active'?'on':'' ?>"><span class="d"></span><?= e(ucfirst($r['status'])) ?></span>
        <a class="lnk" href="<?= e(url('backoffice/counters/'.$r['id'])) ?>">Editeaza</a></div>
    </div>
  <?php endforeach; ?>
    ...
    <div class="mcard">
      ...
      <div class="mbody"><code style="font-size:1.1rem;font-weight:800"><?= e($d['connection_key']) ?></code>
        <div style="margin-top:.6rem;display:flex;gap:.4rem;flex-wrap:wrap">
          ...
          <?php if(in_array($d['type'],['player','widget_player'],true)): ?><a class="btn btn-primary" href="<?= e(url('backoffice/devices/'.$d['id'].'/player')) ?>" style="padding:.4rem .7rem">Design</a><?php endif; ?>
          <?php if(in_array($d['type'],['dispenser','digital_ticket'],true)): ?><a class="btn btn-primary" href="<?= e(url('backoffice/devices/'.$d['id'].'/dispenser')) ?>" style="padding:.4rem .7rem">Config</a><?php endif; ?>
        </div>
      </div>
      <div class="card-foot"><span class="st <?= $d['online']?'on':'' ?>"><span class="d"></span><?= $d['online']?'Online':'Offline' ?></span>
        <a class="lnk" href="<?= e(url('backoffice/devices/'.$d['id'])) ?>">Editeaza</a></div>
    </div>
  <?php endforeach; ?>
